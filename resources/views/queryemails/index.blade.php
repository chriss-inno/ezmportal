            ...
            $('#branches').dataTable( {
                "fnDrawCallback": function( oSettings ) {
                    ...
                    $(".editEmail").click(function(){
                        ...
                        $(".modal-body").load("<?php echo url("queryemails") ?>/"+id1+"/edit");
                    ...
                    $(".createEmail").click(function(){
                        ...
                        $("#myModal").modal("show");
                        $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
                        $(".modal-body").load("<?php echo url("queryemails/create")?>");
                        $("#myModal").on('hidden.bs.modal',function(){
                            $("#myModal").remove();
                        })
                    ...
                    $(".deleteEmail").click(function(){
                        ...
                        $("#yes").click(function(){
                            ...
                            $.get("<?php echo url('queryemails-remove') ?>/"+id1,function(data){
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="btn-group btn-group-justified">
                                    ...
                                    <a href="{{url('queries/mytask')}}" class="btn btn-file btn-primary"><i class="fa fa-tasks"></i> Attend queries</a> <a href="{{url('queries/progress')}}" class="btn btn-file btn-primary"><i class="fa fa-archive"></i> Queries Progress</a>

                                    <a href="{{url('queries/history')}}" class="btn btn-file btn-primary"> <i class="fa fa-bars"></i> History</a> @if(\App\Http\Controllers\RightsController::moduleAccess(Auth::user()->right_id,21) || Auth::user()->user_type=="Administrator")
