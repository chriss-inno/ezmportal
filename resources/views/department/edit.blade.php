            ...
            <div class="col-lg-10 col-md-10">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <hr/>
                        {!! Form::open(array('url'=>'departments/edit','role'=>'form','id'=>'DepartmentForm')) !!}
                        <div class="form-group">
                            <label for="status">Branch</label>
                            <select name="branch_id" class="form-control" id="branch_id">
                                @if($dep->branch_id !="")
                                    <option selected value="{{$dep->branch_id}}">{{$dep->branch->branch_Name}}</option>
                               @else
                                    <option selected value="{{$dep->branch_id}}">----</option>
                                @endif
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="department_name" name="department_name" @if(old('department_name') !="") value="{{old('department_name')}}" @else value="{{$dep->department_name}}" @endif placeholder="Enter Department Name">
                        </div>
                        <div class="form-group">
                            <label for="description">Descriptions</label>
                            <textarea class="form-control" id="description" rows="8" name="description">@if(old('description') !=""){{old('description')}}@else{{$dep->description}}@endif</textarea>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select name="status" class="form-control" id="status">
                                        @if(old('description') !="")  <option selected value="{{old('status')}}">{{old('status')}}</option>
                                        @else <option selected value="{{$dep->status}}">{{$dep->status}}</option>  @endif
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="download_check" class="form-control" id="status">
                                        @if($dep->download_check != null && $dep->download_check !="")
                                            <option value="{{$dep->download_check}}" selected>{{$dep->download_check}}</option>
                                         @else
