...
<fieldset class="scheduler-border">
    ...
    {!! Form::open(array('url'=>'services/edit','role'=>'form','id'=>'serviceForm')) !!}
    <div class="form-group">
        <label for="unit_name">Service Name</label>
        <input type="text" class="form-control" id="service_name" name="service_name" placeholder="Enter service name" required value="{{$services->service_name}}">
    </div>
    <div class="form-group">
        <label for="unit_name">Service Description</label>
        <textarea class="form-control" id="description" name="description">{{$services->description}}</textarea>
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-md-4">
                ...
                <select name="status" class="form-control" id="status">
                    ...
                    <option selected value="{{$services->status}}">{{$services->status}}</option>
                    <option value="" >----</option>
