            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3 class="text-info"> <strong><i class="fa fa-download text-danger"> </i></i> Portal Downloads: {{$department->department_name}}</strong></h3>
                    </header>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="adv-table">
                                    <table  class="display table table-bordered table-striped" id="branches">
                                        ...
                                        <tbody>
                                        <?php $i=1;?>
                                        @if($department->downloads !=null && $department->downloads != "")
                                            @foreach($department->downloads as $download)
                                                @if($download->restricted =='Yes')
