                ...
                "fnDrawCallback": function( oSettings ) {
                    ...
                    $(".deleteItem").click(function(){
                        ...
                        $("#yes").click(function(){
                            ...
                            $.get("<?php echo url('downloads-remove') ?>/"+id1,function(data){
                                        ...
                                        @foreach($downloads as $download)
                                            <tr>
                                                ...
                                                <td id="{{$download->id}}" align="center">
                                                    <div class="pull-right hidden-phone" id="{{$download->id}}">
                                                        <a  href="#" title="show item details" class=" btn btn-info btn-xs"><i class="fa fa-eye"> View</i></a>
                                                    </div>

                                                </td>
                                                <td id="{{$download->id}}" align="center">
                                                    <a  href="{{url('downloads/edit')}}/{{$download->id}}" title="" class=" btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
