                ...
                "fnDrawCallback": function (oSettings) {
                    ...
                    $(".delUnit").click(function(){
                        ...
                        $("#yes").click(function(){
                            ...
                            $.get("<?php echo url('units/remove') ?>/"+id1,function(data){
                    ...
                    $(".addUnit").click(function(){
                        ...
                        modaldis+= '<span id="myModalLabel" class="h2 modal-title text-center text-info text-center" style="color: #FFF;">Create new </span>';
                        modaldis+= '</div>';
                        ...
                        $(".modal-body").load("<?php echo url("units/create") ?>");
                    ...
                    $(".editUnit").click(function(){
                        ...
                        $("#myModal").modal("show");
                        $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
                        $(".modal-body").load("<?php echo url("units/edit") ?>/"+id1);
                        $("#myModal").on('hidden.bs.modal',function(){
                            $("#myModal").remove();
                        })
            ...
            <div class="col-lg-10 col-md-10">
                <section class="panel">
                    <header class="panel-heading">
                        <h3 class="text-info"> <strong><i class="fa fa-building"></i> <i class="fa fa-cogs text-danger"></i> MANAGE DEPARTMENT UNITS </strong></h3>
                    </header>
                                ...
                                @if(count($units) >0)
                                    ...
                                    @foreach($units as $unit)
                                        <tr>
                                            ...
                                            @if($unit->parent_id != 0 && $unit->parent_id != null && $unit->parent_id != "")
                                                <td>{{$unit->subunit->unit_name}}</td>
                                            @else
                                                <td></td>
                                                @endif
                                            <td>{{$unit->department->department_name}}</td>
                                            <td>{{$unit->department->branch->branch_Name}}</td>
                                            <td>{{$unit->status}}</td>
            ...
            <div class="col-lg-2 col-md-2">
                <section class="panel">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="#" class="addUnit btn btn-compose btn-block">Create New Unit</a>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 10px">
                            <div class="col-md-12">
                                <a href="{{url('departments')}}" class="btn btn-compose btn-block">List Units</a>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 10px">
                            <div class="col-md-12">
                                <a href="{{url('departments/reports')}}" class="btn btn-compose btn-block">Units Reports</a>
                            </div>
                        </div>
                    </div>
                </section>
