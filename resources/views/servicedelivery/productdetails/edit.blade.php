...
{!! Form::model($pdetails, array('route' => array('sdproductdetails.update', $pdetails->id), 'method' => 'PUT','id'=>'InventoryForm')) !!}
<fieldset class="scheduler-border">
    <legend class="scheduler-border" style="color:#005DAD">Basic product details</legend>

    <div class="form-group">
        <label for="item_name">Details name</label>
        <input type="text" class="form-control" id="details_name" name="details_name" value="{{$pdetails->details_name}}" placeholder="Enter product type">
    </div>
    <div class="form-group">
        <label for="description"> Description</label>
        <textarea class="form-control" id="description" name="description">{{$pdetails->description}}</textarea>
    </div>
</fieldset>
