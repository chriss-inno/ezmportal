...
@section('page-title')
    Service delivery advanced search
    @stop
    @section('page_style')
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <section class="panel">
                            <header class="panel-heading">
                                <h3 class="text-info text-center"> <strong>  <i class="fa fa-pie-chart text-danger"></i> CUSTOMER ISSUES  ADVANCED SEARCH</strong></h3>
                            </header>
                            <div class="panel-body">
                                {!! Form::open(array('url'=>'servicedelivery/history','role'=>'form','id'=>'querySearchForm')) !!}
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
