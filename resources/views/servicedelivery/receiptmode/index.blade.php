                ...
                "fnDrawCallback": function( oSettings ) {
                    ...
                    $(".deleteProduct").click(function(){
                        ...
                        $("#yes").click(function(){
                            ...
                            $.get("<?php echo url('sdreceiptmodes-remove') ?>/"+id1,function(data){
                    ...
                    $(".editProduct").click(function(){
                        ...
                        modaldis+= '<span id="myModalLabel" class="h2 modal-title text-center" style="color: #FFF">Update Receipt mode</span>';
                        modaldis+= '</div>';
                        ...
                        $(".modal-body").load("<?php echo url("sdreceiptmodes") ?>/"+id1+"/edit");
                    ...
                    $(".createProduct").click(function(){
                        ...
                        modaldis+= '<div class="modal-header">';
                        modaldis+= '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
                        modaldis+= '<span id="myModalLabel" class="h2 modal-title text-center text-info text-center" style="color: #FFF;">Create New Receipt mode </span>';
                        modaldis+= '</div>';
                        modaldis+= '<div class="modal-body">';
                        modaldis+= ' </div>';
                        modaldis+= '</div>';
                        ...
                        $("#myModal").modal("show");
                        $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
                        $(".modal-body").load("<?php echo url("sdreceiptmodes/create") ?>");
                        $("#myModal").on('hidden.bs.modal',function(){
                            $("#myModal").remove();
                        })
                    ...
                    $(".showDetails").click(function(){
                        ...
                        modaldis+= '<div class="modal-header">';
                        modaldis+= '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
                        modaldis+= '<span id="myModalLabel" class="h2 modal-title text-center text-info text-center" style="color: #FFF;">View Receipt mode</span>';
                        modaldis+= '</div>';
                        modaldis+= '<div class="modal-body">';
                        modaldis+= ' </div>';
                        modaldis+= '</div>';
                        ...
                        $("#myModal").modal("show");
                        $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
                        $(".modal-body").load("<?php echo url("sdreceiptmodes") ?>/"+id1);
                        $("#myModal").on('hidden.bs.modal',function(){
                            $("#myModal").remove();
                        })
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3 class="text-info"> <strong><i class="fa fa-cogs text-danger"></i> SERVICE DELIVERY  RECEIPT MODES</strong></h3>
                    </header>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="btn-group btn-group-justified">
                                    <a href="#" class="createProduct btn btn-file btn-primary">New receipt mode</a>

                                    <a href="{{url('sdproducts')}}" class="btn btn-file btn-primary">View receipt mode</a>

                                    <a href="{{url('sdproducts')}}" class="btn btn-file btn-primary">Manage receipt mode</a>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="adv-table">
                                    <table  class="display table table-bordered table-striped" id="branches">
                                        ...
                                        <tbody>
                                        <?php $i=1;?>
                                        @foreach($modes as $prod)
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td>{{$prod->mode_name}}</td>
