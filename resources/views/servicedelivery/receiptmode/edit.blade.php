...
{!! Form::model($modes, array('route' => array('sdreceiptmodes.update', $modes->id), 'method' => 'PUT','id'=>'InventoryForm')) !!}
<fieldset class="scheduler-border">
    <legend class="scheduler-border" style="color:#005DAD">Basic product details</legend>

    <div class="form-group">
        <label for="item_name"> Mode name</label>
        <input type="text" class="form-control" id="mode_name" name="mode_name" value="{{$modes->mode_name}}" placeholder="Enter product type">
    </div>
    <div class="form-group">
        <label for="description"> Description</label>
        <textarea class="form-control" id="description" name="description">{{$modes->description}}</textarea>
    </div>
</fieldset>
