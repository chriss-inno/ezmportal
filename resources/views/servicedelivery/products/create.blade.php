...
{!! Form::open(array('url'=>'sdproducts','role'=>'form','id'=>'InventoryForm')) !!}
<fieldset class="scheduler-border">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="product_type" name="product_type" value="{{old('product_type')}}" placeholder="Enter product type">
    </div>
    <div class="form-group">
