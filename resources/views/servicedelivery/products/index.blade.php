                ...
                "fnDrawCallback": function( oSettings ) {
                    ...
                    $(".deleteProduct").click(function(){
                        ...
                        $("#yes").click(function(){
                            ...
                            $.get("<?php echo url('sdproducts-remove') ?>/"+id1,function(data){
                    ...
                    $(".editProduct").click(function(){
                        ...
                        $(".modal-body").load("<?php echo url("sdproducts") ?>/"+id1+"/edit");
                    ...
                    $(".createProduct").click(function(){
                        ...
                        $("#myModal").modal("show");
                        $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
                        $(".modal-body").load("<?php echo url("sdproducts/create") ?>");
                        $("#myModal").on('hidden.bs.modal',function(){
                            $("#myModal").remove();
                        })
                    ...
                    $(".showDetails").click(function(){
                        ...
                        $("#myModal").modal("show");
                        $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
                        $(".modal-body").load("<?php echo url("sdproducts") ?>/"+id1);
                        $("#myModal").on('hidden.bs.modal',function(){
                            $("#myModal").remove();
                        })
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3 class="text-info"> <strong><i class="fa fa-cogs text-danger"></i> SERVICE DELIVERY PRODUCTS</strong></h3>
                    </header>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="btn-group btn-group-justified">
                                    <a href="#" class="createProduct btn btn-file btn-primary">New Product types</a>

                                    <a href="{{url('sdproducts')}}" class="btn btn-file btn-primary">View Products types</a>

                                    <a href="{{url('sdproducts')}}" class="btn btn-file btn-primary">Manage Products types</a>
