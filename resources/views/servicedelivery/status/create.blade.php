...
{!! Form::open(array('url'=>'sdstatus','role'=>'form','id'=>'InventoryForm')) !!}
<fieldset class="scheduler-border">
    <legend class="scheduler-border" style="color:#005DAD">Basic status details</legend>

    <div class="form-group">
        <label for="status_name">Status name</label>
        <input type="text" class="form-control" id="status_name" name="status_name" value="{{old('status_name')}}" placeholder="Enter status_name">
    </div>
</fieldset>
