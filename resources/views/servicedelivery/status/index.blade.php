                ...
                "fnDrawCallback": function( oSettings ) {
                    ...
                    $(".deleteProduct").click(function(){
                        ...
                        $("#yes").click(function(){
                            ...
                            $.get("<?php echo url('sdstatus-remove') ?>/"+id1,function(data){
                    ...
                    $(".editProduct").click(function(){
                        ...
                        $(".modal-body").load("<?php echo url("sdstatus") ?>/"+id1+"/edit");
                    ...
                    $(".createProduct").click(function(){
                        ...
                        $("#myModal").modal("show");
                        $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
                        $(".modal-body").load("<?php echo url("sdstatus/create") ?>");
                        $("#myModal").on('hidden.bs.modal',function(){
                            $("#myModal").remove();
                        })
                    ...
                    $(".showDetails").click(function(){
                        ...
                        $("#myModal").modal("show");
                        $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
                        $(".modal-body").load("<?php echo url("sdstatus") ?>/"+id1);
                        $("#myModal").on('hidden.bs.modal',function(){
                            $("#myModal").remove();
                        })
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3 class="text-info"> <strong><i class="fa fa-cogs text-danger"></i> SERVICE DELIVERY STATUS</strong></h3>
                    </header>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="btn-group btn-group-justified">
                                    <a href="#" class="createProduct btn btn-file btn-primary">New Status</a>

                                    <a href="{{url('sdstatus')}}" class="btn btn-file btn-primary">View Status</a>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="adv-table">
                                    <table  class="display table table-bordered table-striped" id="branches">
                                        ...
                                        <tbody>
                                        <?php $i=1;?>
                                        @foreach($status as $prod)
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td>{{$prod->status_name}}</td>
                                                <td>{{$prod->input_by}}</td>
