                                ...
                                <fieldset class="scheduler-border">
                                    ...
                                    <div class="form-group">
                                        <table  class="display table table-bordered table-striped" id="branches">
                                            ...
                                            <tr>
                                                <td colspan="11">{{$issue->description}}</td>
                                            </tr>
                                            <tr>
                                                <th colspan="11">Root Cause</th>
                                            </tr>
                                            <tr>
                                                <td colspan="11">{{$issue->root_cause}}</td>
                                            </tr>
                                            <tr>
                                                <th colspan="11">Remarks</th>
                                            </tr>
                                            <tr>
                                                <td colspan="11">{{$issue->remarks}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-2 col-sm-2 col-xs-2 pull-right">
                                            <a href="{{url('servicedelivery')}}"  class="btn btn-danger btn-block"> <i class="icon-remove"></i>  Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
