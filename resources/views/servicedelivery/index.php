...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #7F9DB9; border-left: 1px solid #7F9DB9; border-right: 1px solid #7F9DB9; border-top: 1px solid #7F9DB9; ">
  <tr>
    <td width="95%" height="20" nowrap ><table width="100%" height="20"  border="0" align="center" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #7F9DB9;">
        <tr >
          <td width="96%" height="19" nowrap bgcolor="#E1204F" ><span class="style5">&nbsp;<span class="style21"><span class="style3">CUSTOMER ISSUES TRACKING </span></span></span></td>
        </tr>
    </table></td>
  </tr>
  <tr>
    <td height="166" valign="top" nowrap><div align="center">
	 ...
	 $query = mysql_query(" SELECT * FROM sys_user_right WHERE usr_id = '$loginUser_id' AND (rgt_name = 'CUSTOMERQUERYTRACKINGINPUT' OR rgt_name = 'CUSTOMERQUERYTRACKINGVIEW')");  
	 $count = 1;
			  $result = $query;
		      if($result) 
		             {
	 ...
	 //exit;
	 //}
	 //elseif ($rgtname != "CUSTOMERQUERYTRACKINGVIEW")
	 //{
     //include_once 'unuthorized.php';	
	 //exit;
	 //}
          ...
          <td width="61%" align="left" valign="middle" nowrap><div align="left"><span class="style1"></span> </div>
              ...
              <table width="100%" height="120"  border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="99%" align="left" valign="middle" nowrap><span class="style1"><span class="style23"><a href="rec-page.php?form=Access%20Form%20Revised.pdf" target="_self">RECORD NEW  ISSUE </a></span></span></td>
                </tr>
				<tr>
				  <td align="left" valign="middle" nowrap class="style6 style7">&nbsp;</td>
				  <td align="left" valign="middle" nowrap><span class="style1"><span class="style23"><a href="prg-issueall.php?form=Access%20Form%20Revised.pdf" target="_self">UPDATE ISSUE </a></span></span></td>
			    </tr>
				<tr>
                  <td width="1%" align="left" valign="middle" nowrap class="style6 style7">&nbsp;</td>
                  <td width="99%" align="left" valign="middle" nowrap><span class="style1"><span class="style23"><a href="vie-issueall.php?form=Access%20Form%20Revised.pdf" target="_self">VIEW ISSUES PROGRESS </a></span></span></td>
                </tr><tr>
                  <td width="1%" align="left" valign="middle" nowrap class="style6 style7">&nbsp;</td>
                  <td width="99%" align="left" valign="middle" nowrap><span class="style1"><span class="style23"><a href="rpt-generateselection.php?form=Access%20Form%20Revised.pdf" target="_self">GENERATE ISSUES REPORT </a></span></span></td>
                </tr>
            </table></td>
        </tr>
        <tr>
