            ...
            <div class="col-lg-12 col-md-12">
                <section class="panel">
                    <div class="panel-body">
                        <p> <h3 class="text-center">Import SD PROGRESS From MS Excel </h3>
                        @if (count($errors) > 0)
                        ...
                        @endif
                        <hr/>
                        {!! Form::open(array('url'=>'servicedelivery/migrate/progress','role'=>'form','id'=>'importInventory','files' => true)) !!}
