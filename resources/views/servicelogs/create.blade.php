...
{!!HTML::style("assets/dp/css/bootstrap-datetimepicker.min.css" )!!}
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class=" datetimepicker1" data-format="dd/MM/yyyy hh:mm:ss" id="start_time" name="start_time" value="{{old('start_time')}}" placeholder="(YYYY-MM-DD HH:MM)">
                                   </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control datetimepicker1" id="end_time" name="end_time" value="{{old('end_time')}}" placeholder="(YYYY-MM-DD HH:MM)" data-format="dd/MM/yyyy hh:mm:ss">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
