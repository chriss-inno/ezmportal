            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3 class="text-info"> <strong><i class="fa  fa-pie-chart"></i> <i class="fa  fc-agenda-days text-danger"></i> Daily Portal Reports as of {{date("d F, Y",strtotime($dateas))}} </strong></h3>
                    </header>
