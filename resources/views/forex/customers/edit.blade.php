...
{!! Form::open(array('url'=>'forex/customers/edit','role'=>'form','id'=>'InventoryForm')) !!}
<fieldset class="scheduler-border">
    <legend class="scheduler-border" style="color:#005DAD">Basic Customer details</legend>

    <div class="form-group">
        <label for="customer_name">Customer Name</label>
        <input type="text" class="form-control" id="customer" name="customer" value="{{$customer->customer}}"  placeholder="Enter customer name">
    </div>
    <div class="form-group">
        <label for="rm_code">Phone Number</label>
        <input type="text" class="form-control" id="rm_code" name="rm_code" value="{{$customer->rm_code}}" placeholder="Enter rm code">
    </div>
    <div class="form-group">
        <div class="row">
