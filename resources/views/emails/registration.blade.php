...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #0f74b8;font-family:Tahoma,Geneva,sans-serif;color: #0f74b8;font-size: 14px;">
    ...
    <tr>
        <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="2" cellpadding="2">
                <tr>
                    <td colspan="4" bgcolor="#0f74b8" style="color:#FFFFFF"><strong>User account details,</strong></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" bgcolor="#0f74b8" style="color:#FFFFFF"><strong>User login details</strong></td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF"><strong><span style="color:#0f74b8">User Name</span></strong></td>
                    <td colspan="3">{{$user->username}}</td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF"><strong><span style="color:#0f74b8">Password</span></strong></td>
