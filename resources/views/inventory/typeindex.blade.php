    ...
    <script type="text/javascript" charset="utf-8">
        $(document).ready(function() {
            ...
            $(".deleteType").click(function(){
                ...
                $(".deleteType").show("slow").parent().parent().find("span").remove();
                var btn = $(this).parent().parent();
                $(this).hide("slow").parent().append("<span><br>Are You Sure <br /> <a href='#s' id='yes' class='btn btn-success btn-xs'><i class='fa fa-check'></i> Yes</a> <a href='#s' id='no' class='btn btn-danger btn-xs'> <i class='fa fa-times'></i> No</a></span>");
                $("#no").click(function(){
                    $(this).parent().parent().find(".deleteType").show("slow");
            ...
            $(".editType").click(function(){
                ...
                $(".modal-body").load("<?php echo url("types") ?>/"+id1+"/edit");
            ...
            $(".createType").click(function(){
                ...
                modaldis+= '<div class="modal-header">';
                modaldis+= '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
                modaldis+= '<span id="myModalLabel" class="h2 modal-title text-center text-info text-center" style="color: #FFF;">Create Item type </span>';
                modaldis+= '</div>';
                modaldis+= '<div class="modal-body">';
                modaldis+= ' </div>';
                modaldis+= '</div>';
                ...
                $("#myModal").modal("show");
                $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
                $(".modal-body").load("<?php echo url("types/create") ?>");
                $("#myModal").on('hidden.bs.modal',function(){
                    $("#myModal").remove();
                })
            ...
            <div class="col-lg-10 col-md-10">
                <section class="panel">
                    <header class="panel-heading">
                        <h3 class="text-info"> <strong><i class="fa fa-suitcase"></i> INVENTORY ITEMS  TYPES</strong></h3>
                    </header>
            ...
            <div class="col-lg-2 col-md-2">
                <section class="panel">
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-top: 10px">
                            <div class="col-md-12">
                                <a href="{{url('inventory')}}" class="btn btn-primary btn-block">List inventory items</a>
                            </div>
                        </div>
                    </div>
                </section>
