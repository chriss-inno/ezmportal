...
<table>
    <thead>
    <tr>
            <th bgcolor="#CCCCCC" colspan="11" align="center">DAILY LOGGED QUERIES AS OF {{strtoupper(date("d-M-Y"))}}</th>
    ...
    @foreach($queries as $qr)
        ...
        <tr id="{{$qr->id}}">
            ...
            <?php $departmentTO=\App\Department::find($qr->to_department);?>
            <td>{{$departmentTO->department_name}}</td>
