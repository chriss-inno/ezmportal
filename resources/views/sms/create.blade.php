...
{!!HTML::script("assets/data-tables/DT_bootstrap.js") !!}
    ...
    {!! Form::open(array('url'=>'sms/customers/create','role'=>'form','id'=>'InventoryForm')) !!}
<fieldset class="scheduler-border">
    <legend class="scheduler-border" style="color:#005DAD">Basic Customer details</legend>

    <div class="form-group">
            <label for="customer_name">Customer Name</label>
            <input type="text" class="form-control" id="customer_name" name="customer_name" value="{{old('customer_name')}}" placeholder="Enter customer_name">
    </div>
    <div class="form-group">
