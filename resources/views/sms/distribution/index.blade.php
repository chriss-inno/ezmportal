    ...
    <script type="text/javascript" charset="utf-8">
        $(document).ready(function() {
            ...
            $(".editItem").click(function(){
                ...
                $(".modal-body").load("<?php echo url("sms/dispatch/edit") ?>/"+id1);
            ...
            $(".createItem").click(function(){
                ...
                modaldis+= '<div class="modal-header">';
                modaldis+= '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
                modaldis+= '<span id="myModalLabel" class="h2 modal-title text-center text-info text-center" style="color: #FFF;">New Group </span>';
                modaldis+= '</div>';
                modaldis+= '<div class="modal-body">';
                modaldis+= ' </div>';
                modaldis+= '</div>';
                ...
                $("#myModal").modal("show");
                $(".modal-body").html("<h3><i class='fa fa-spin fa-spinner '></i><span>loading...</span><h3>");
                $(".modal-body").load("<?php echo url("sms/dispatch/create") ?>");
                $("#myModal").on('hidden.bs.modal',function(){
                    $("#myModal").remove();
                })
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3 class="text-info"> <strong><i class="fa fa-users text-danger"></i> Messages dispatch groups </strong></h3>
                    </header>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="btn-group btn-group-justified">
                                    ...
                                    <a href="{{url('sms/dispatch')}}" class="btn btn-file btn-primary">View Groups</a>
                                    <a href="{{url('sms/customers')}}" class="btn btn-file btn-primary"> Customers</a>
                        ...
                        <div class="row">
                            ...
                            <table  class="display table table-bordered table-striped" id="branches">
                                ...
                                @foreach($distribution as $dist)
                                    <tr>
                                        <td>{{$i++}}</td>
                                        <td>{{$dist->list_name}}</td>
                                        <td>{{$dist->descriptions}}</td>
                                        <td> <a  href="{{url('sms/dispatch/customers')}}/{{$dist->id}}" title="Edit " class=" btn btn-info btn-xs"><i class="fa fa-eye">View/Import</i></a></td>
                                        @if($dist->status =="Enabled" || $dist->status =="enabled")
                                            <td><a  href="#"  class=" btn btn-success btn-xs"> {{ucwords(strtolower($dist->status)) }} </a></td>
                                        @else
                                            <td><a  href="#"  class=" btn btn-danger btn-xs"> {{ucwords(strtolower($dist->status)) }} </a></td>
                                            @endif
                                        <td id="{{$dist->id}}" align="center">
