...
@section('page_scripts')
    ...
    <script type="text/javascript" charset="utf-8">
        function messageCharCount(data)
        {
            document.getElementById("messagecount").value=data.value.length;
        }
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-top: 20px">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <p>  <h3 class="text-info"> Send message to  distribution list </h3>
                                @if (count($errors) > 0)
                                ...
                                @endif
                                <hr/>
                                {!! Form::open(array('url'=>'sms/messages/create','role'=>'form','id'=>'messageDispatch')) !!}
                                <div class="form-group">
                                    <label for="dispatch_name">Message Title </label>
                                    <input type="text" id="message_title"  class="form-control" name="message_title" value="{{}}">
                                    <p class="text-danger"><strong>Please note:</strong> The message title won't be sent to customer, will be used for reference in message history</p>
                                ...
                                <div class="form-group">
                                    <label for="dispatch_name">Message count </label>
                                    <input type="text" id="messagecount" readonly class="form-control">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                            <select  class=" form-control" name="dispatch_id" id="dispatch_id" required>
                                                ...
                                                @foreach($distblists as $dst)
                                                    ...
                                                    <option value="{{$dst->id}}" >{{$dst->list_name}}</option>
