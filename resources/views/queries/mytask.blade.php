        ...
        @if(\App\Http\Controllers\RightsController::moduleAccess(Auth::user()->right_id,13) || Auth::user()->user_type=="Administrator")
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li class="active"><a  href="{{url('queries/mytask')}}" title="Attend queries">Attend queries</a></li>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3 class="text-info"> <strong><i class="fa  fa-tasks"></i> QUERY ATTEND </strong></h3>
                    </header>
