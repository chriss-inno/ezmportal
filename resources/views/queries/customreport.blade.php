                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <section class="panel">
                            <header class="panel-heading">
                                <h3 class="text-info"> <strong> <i class="fa fa-pie-chart"></i> SERVICE PORTAL QUERIES CUSTOM REPORTS</strong></h3>
                            </header>
                            <div class="panel-body">
                                {!! Form::open(array('url'=>'queries/report/custom','role'=>'form','id'=>'querySearchForm')) !!}
                                    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <select class="form-control"  id="module" name="module">
                                                            <option value="">---</option>
                                                                <?php $modulesq=\App\Module::all();?>
                                                                    @foreach($modulesq as $module)
