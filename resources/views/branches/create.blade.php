            ...
            <div class="col-lg-10 col-md-10">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <hr/>
                            {!! Form::open(array('url'=>'branches/create','role'=>'form','id'=>'branchForm')) !!}
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="branch_code">Branch Code</label>
                                        <input type="text" class="form-control" id="branch_code" name="branch_code" value="{{old('branch_code')}}" placeholder="Enter Branch Code">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
