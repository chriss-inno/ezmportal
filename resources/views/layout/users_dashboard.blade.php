        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                <div class="row">
                    <section class="panel">
                        <header class="panel-heading" >
                            <h3 class="text-info"> <i class="fa  fa-info-circle"> USEFUL LINKS </i> </h3>
                        </header>
                        <div class="panel-body">
                            @if(\App\Http\Controllers\RightsController::moduleAccess(Auth::user()->right_id,13) || Auth::user()->user_type=="Administrator")
                            <div class="row" style="margin-top: 10px" id ="{{$user->id}}">
                                <div class="col-md-12">
                                    <a  href="{{url('queries/create')}}" class=" btn btn-primary btn-block"><i class="fa  fa-user"></i> log Query</a>
                                </div>
                            </div>
                            <div class="row" style="margin-top: 10px" id ="{{$user->id}}">
                                <div class="col-md-12">
                                    <a  href="{{url('queries/mytask')}}" class=" btn btn-primary btn-block"><i class="fa fa-tasks"></i> Attend queries</a>
                                </div>
                            </div>
                            @endif
                            @if(\App\Http\Controllers\RightsController::moduleAccess(Auth::user()->right_id,1)  || Auth::user()->user_type=="Administrator")
                                <div class="row" style="margin-top: 10px" id ="{{$user->id}}">
                                    <div class="col-md-12">
                                        <a  href="{{url('portal/reports/daily')}}" class=" btn btn-primary btn-block"><i class="fa  fa-line-chart"></i> Portal Reports</a>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="row" style="margin-top: 10px" id ="{{$user->id}}">
                                <div class="col-md-12">
                                    <a href="{{url('serviceslogs/create')}}" class=" btn btn-primary btn-block"><i class="fa  fa-line-chart"></i> Services Status</a>
                                </div>
                            </div>
                            @endif
                            @if(\App\Http\Controllers\RightsController::moduleAccess(Auth::user()->right_id,19) || Auth::user()->user_type=="Administrator")
                            <div class="row" style="margin-top: 10px" id ="{{$user->id}}">
                                <div class="col-md-12">
                                    <a href="{{url('inventory')}}" class=" btn btn-primary btn-block"><i class="fa fa-laptop "> </i><i class="fa fa-database text-danger"></i> ICT Inventory</a>
                                </div>
                            </div>
                                @endif
                        </div>
                ...
                <div class="row">
                    <section class="panel">
                        <header class="panel-heading" >
                            <h3 class="text-info"> <i class="fa  fa-user"> MY PROFILE </i> </h3>
                        </header>
                        <div class="panel-body">
